<?php
	...
	$form_body .= "<br /><label>" . elgg_echo('feedback:comments:new') . "</label><br />";
	...
	$form_body .= elgg_view('input/longtext', array('internalname' => 'feedback_comments', 'internalid' => 'feedback_comments'));
